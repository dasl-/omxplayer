...
LDFLAGS+=-lasound -lfreetype -lavcodec -lavformat -lavutil -lbcm_host -lbrcmEGL -lbrcmGLESv2 -lc -ldbus-1 -lopenmaxil -lpcre -lpthread -lrt -lswresample -lswscale -lvchiq_arm -lvchostif -lvcos -lz

INCLUDES+=-I./ -Ilinux -Iffmpeg_compiled/usr/local/include -I /usr/include/dbus-1.0 -I/usr/include/freetype2 -I /usr/lib/arm-linux-gnueabihf/dbus-1.0/include -isystem$(SDKSTAGE)/opt/vc/include -isystem$(SDKSTAGE)/opt/vc/include/interface/vcos/pthreads
